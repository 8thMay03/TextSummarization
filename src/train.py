...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--max-train-samples", type=int, default=DEFAULT_CONFIG.train_sample_size)
    parser.add_argument("--max-eval-samples", type=int, default=DEFAULT_CONFIG.eval_sample_size)
